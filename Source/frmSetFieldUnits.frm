...
Begin VB.Form frmSetFieldUnits 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Neutron and Photon Radiation Field Units Selection"
   ClientHeight    =   5220
   ClientLeft      =   1125
   ClientTop       =   2220
   ClientWidth     =   7635
   ...
   Begin CSOptLib.CSOptList optAreaPrefix 
      ...
      EndProperty
      Contents        =   $"frmSetFieldUnits.frx":0000
      Spacing         =   23
      ItemGap         =   5
      Caption         =   "Area Prefix"
      ListIndex       =   4
   ...
   Begin CSOptLib.CSOptList optDose 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Contents        =   $"frmSetFieldUnits.frx":0093
      Spacing         =   20
      Caption         =   "Dose"
      ListIndex       =   0
      BeginProperty ItemFont {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
   ...
   Begin CSOptLib.CSOptList optDosePrefix 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Contents        =   $"frmSetFieldUnits.frx":00A9
      Spacing         =   23
      ItemGap         =   5
      Caption         =   "Prefix"
      ListIndex       =   8
   ...
   End
End
Attribute VB_Name = "frmSetFieldUnits"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Private Const MODULE_NAME As String = "frmSetFieldUnits"
...
Sub UpdateUnitsString()
   ...
   sUnits = sa_Dose(optDose.ListIndex) & " / " & _
            sa_Dose(optDose.ListIndex)
   lblUnits = sa_Dose(optDose.ListIndex) & " / " & sDose2(optDose.ListIndex)
